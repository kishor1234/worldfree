        ...
        <div class="page-content">
            <div class="row page-row">
                <div class="news-wrapper col-lg-8">                         
                    ...
                    $limit = 10;
                    $ct=$_REQUEST["ct"];
                    $sql = $main->selectCount("post", "id").$main->whereSingle(array("category"=>$_REQUEST["ct"])) ;
                    ...
                    $sql = $main->select("post", $_SESSION["db_1"]).$main->whereSingle(array("category"=>$_REQUEST["ct"])) .$main->orderBy("DESC","id"). $main->limitWithOffset($offset, $limit);
                    $result = $main->adminDB[$_SESSION["db_1"]]->query($sql);
                    $i = 0;
                        ...
                        <div class="col-lg-12">
                            <ul class = "pagination pagination-sm" style="float: right;">
                                ...
                                if ($k == $page) {
                                    ...
                                    ?> <li><a href = '/?r=<?php echo $obj->encdata("C_OpenLink") . "&v=" . $obj->encdata("VperCtg") . "&pg=" . $k."&ct=".$ct; ?>' >&laquo;</a></li><?php
                                    }
                                    ...
                                    while ($i < $max_count) {
                                        if ($k == $page) {
                                            ...
                                            ?><li><a href ='/?r=<?php echo $obj->encdata("C_OpenLink") . "&v=" . $obj->encdata("VperCtg") . "&pg=" . $k."&ct=".$ct; ?>' > <?php echo $k; ?></a></li><?php
                                        }
                                        $k++;
                                        $i = $i + $limit;
                                    }
                                    ...
                                    if ($fl == $k) {
                                        ...
                                        $t = $page + 1;
                                        ?> <li><a href = '/?r=<?php echo $obj->encdata("C_OpenLink") . "&v=" . $obj->encdata("VperCtg") . "&pg=" . $t."&ct=".$ct; ?>' >&raquo;</a></li><?php
                                    }
                                    ?>
